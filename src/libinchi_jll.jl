...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libinchi_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("172afb32-8f1c-513b-968f-184fcd77af72"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libinchi", artifacts_toml) for e in artifacts["libinchi"]]
...
if best_platform === nothing
    @debug("Unable to load libinchi; unsupported platform $(triplet(platform_key_abi()))")
else
