# Autogenerated wrapper script for libinchi_jll for x86_64-apple-darwin14
export libinchi
...
const libinchi_splitpath = ["lib", "libinchi.1.05.dylib"]
...
const libinchi = "@rpath/libinchi.1.dylib"
